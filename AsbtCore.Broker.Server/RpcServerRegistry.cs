...
namespace AsbtCore.Broker.Server
{
    public sealed class RpcServerRegistry
    {
        ...
        {
            return map.TryGetValue(interfaceName, out descriptor!);
        }
        ...
        private static Dictionary<string, System.Reflection.MethodInfo> BuildMethodMap(Type interfaceType, Type implementationType)
        {
            var result = new Dictionary<string, System.Reflection.MethodInfo>(StringComparer.Ordinal);
